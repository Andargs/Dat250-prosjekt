...
Revision ID: 477888cb55d5
Revises: 
Create Date: 2020-10-18 17:30:19.870458
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('ammount', sa.String(length=140), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.Column('recieving', sa.Integer(), nullable=True),
